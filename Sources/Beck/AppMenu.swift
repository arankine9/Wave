...
enum AppMenu {
    ...
    static func install(openSettings: @escaping () -> Void) {
        ...
        let appMenu = NSMenu()
        appMenu.addItem(NSMenuItem(title: "About Beck", action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: ""))
        ...
        appMenu.addItem(.separator())
        appMenu.addItem(NSMenuItem(title: "Hide Beck", action: #selector(NSApplication.hide(_:)), keyEquivalent: "h"))
        let hideOthers = NSMenuItem(title: "Hide Others", action: #selector(NSApplication.hideOtherApplications(_:)), keyEquivalent: "h")
        hideOthers.keyEquivalentModifierMask = [.command, .option]
        appMenu.addItem(hideOthers)
        appMenu.addItem(NSMenuItem(title: "Show All", action: #selector(NSApplication.unhideAllApplications(_:)), keyEquivalent: ""))
        appMenu.addItem(.separator())
        appMenu.addItem(NSMenuItem(title: "Quit Beck", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q"))
