...
public protocol WaveClock: AnyObject, Sendable {
...
public final class RealClock: WaveClock, @unchecked Sendable {
...
public final class TestClock: WaveClock, @unchecked Sendable {
